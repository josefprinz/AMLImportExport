...
namespace ImportExport.SourcePages
{
    ...
    /// </summary>
    public partial class ExporterWithExternalization : CodePage
    {
        ...
        /// </summary>
        public ExporterWithExternalization()
        {
            InitializeComponent();
            Init(SourceCode, "Export/AMLModelAExporterWithExternalization.cs", "Generate(Project");
        }
